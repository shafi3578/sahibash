  ...
  return (
    <form action={publishListingSchemaAction} className="space-y-5">
      ...
      <section className="rounded-2xl border border-[var(--line)] bg-white p-4">
        <h2 className="text-xl font-bold">Detail-page sections</h2>
        <div className="mt-3 space-y-3">
          {config.sections.map((section, index) => <div key={section.key} className="grid gap-3 rounded-xl bg-[var(--surface-2)] p-3 md:grid-cols-[1fr_2fr_7rem_7rem]">
      ...
      <section className="rounded-2xl border border-[var(--line)] bg-white p-4">
        <h2 className="text-xl font-bold">Fields, filters, cards and details</h2>
        ...
        <div className="mt-4 space-y-4">
          {config.fields.map((field, index) => <article key={`${field.key}-${index}`} className="rounded-xl border border-[var(--line)] p-4">
            <div className="grid gap-3 lg:grid-cols-[1fr_1fr_1fr_7rem]">
