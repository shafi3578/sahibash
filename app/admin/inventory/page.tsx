  ...
  const copy = locale === "fa"
    ...
    : locale === "ps"
      ? {
          ...
          empty: "تر اوسه هېڅ ریکارډ نشته.", notCreated: "اعلان لا نه دی جوړ شوی", waiting: "لېږد ترلاسه شوی، خو لا عام اعلان نه دی. له بیاکتنې او بریالۍ جوړونې وروسته به یې تړونی همدلته ښکاره شي.", reviewTransfer: "لېږد بیاکتل", openListing: "اعلان پرانیستل", openSource: "اصلي سرچینه پرانیستل", source: "سرچینه", status: "حالت", created: "جوړ شوی", method: "طریقه", platform: "پلېټفارم", rows: "ریکارډونه", result: "پایله", dryRun: "ازمایښتي اجرا", liveRun: "اصلي اجرا", accepted: "منل شوي", rejected: "رد شوي", errors: "تېروتنې", row: "ریکارډ", sourceItem: "په سرچینه کې پېژند", category: "کټګوري", location: "ځای", price: "بیه", missingCategory: "نه ده ټاکل شوې", missingLocation: "نه دی ټاکل شوی", missingPrice: "نه ده ټاکل شوې", activeSource: "سرچینه فعاله ده", emergencyStop: "بېړنی تم فعال دی", reason: "دلیل", score: "نمره", latest: `وروستي ${RECENT_LIMIT} ریکارډونه ښودل کېږي`, claimsEmpty: "د مالکیت غوښتنه نشته.", duplicatesEmpty: "تکراري مورد نشته.", optOutsEmpty: "منع نه ده ثبت شوې.",
        }
      : {
          ...
          empty: "No records yet.", notCreated: "Listing not created yet", waiting: "The transfer was received, but it is not a public listing yet. After review and successful conversion, its listing link will appear here.", reviewTransfer: "Review transfer", openListing: "Open listing", openSource: "Open original source", source: "Source", status: "Status", created: "Created", method: "Method", platform: "Platform", rows: "Rows", result: "Result", dryRun: "Dry run", liveRun: "Live run", accepted: "Accepted", rejected: "Rejected", errors: "Errors", row: "Row", sourceItem: "Source item", category: "Category", location: "Location", price: "Price", missingCategory: "Not assigned", missingLocation: "Not resolved", missingPrice: "Not normalized", activeSource: "Source enabled", emergencyStop: "Emergency stop enabled", reason: "Reason", score: "Score", latest: `Showing the latest ${RECENT_LIMIT} records`, claimsEmpty: "No ownership claims.", duplicatesEmpty: "No duplicate cases.", optOutsEmpty: "No opt-outs recorded.",
        };
