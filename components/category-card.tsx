...
export function CategoryCard({
  ...
  const categoryHref = localizePath(`/categories/${category.slug}`, locale);

  return (
    <Link
      href={categoryHref}
      className="min-w-0 rounded-2xl border border-[var(--line)] bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
    >
