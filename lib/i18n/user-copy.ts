...
export const USER_COPY = {
  en: {
    ...
    info: {
      ...
      faq: { title: "Frequently asked questions", intro: "Quick answers for buying, selling, accounts, and safety.", body: "How long does an ad stay active?\nAn ad remains active for 30 days. Its owner can publish it again after it expires.\n\nHow do I contact a seller?\nUse the Call or WhatsApp button when the seller has enabled that method. Never send a verification code.\n\nWhy is my ad under review?\nSahibash checks new ads for accurate categories, safe content, genuine photos, and a valid price.\n\nHow do I report a problem?\nOpen Contact Sahibash below and include the listing ID when relevant." },
      contact: { title: "Contact Sahibash", intro: "Send a support request from this page.", body: "Describe the issue clearly and include the listing ID when relevant. Never send your password, verification code, bank PIN, or identity documents." },
    },
  },
  fa: {
    ...
    info: {
      privacy: { title: "حریم خصوصی", intro: "حریم خصوصی شما برای صاحبش مهم است.", body: "معلومات حساب، اعلان، موقعیت و ارتباطات تنها برای فعالیت و امنیت بازار استفاده می‌شود. موقعیت دقیق فقط زمانی نمایش داده می‌شود که خودتان آن را شریک سازید. رمز، کود تأیید یا اسناد حساس هویتی را در اعلان یا پیام نشر نکنید." },
      terms: { title: "شرایط استفاده", intro: "از صاحبش صادقانه، مصئون و قانونی استفاده کنید.", body: "تنها اعلان واقعی را که اجازه عرضه آن را دارید نشر کنید. جنس را درست معرفی کنید، به کاربران احترام بگذارید و محتوای ممنوع، فریب‌کارانه، تبعیض‌آمیز یا خطرناک نشر نکنید. صاحبش می‌تواند محتوای خلاف مقررات بازار را بررسی، محدود یا حذف کند." },
      ...
      faq: { title: "پرسش‌های متداول", intro: "پاسخ‌های کوتاه درباره خرید، فروش، حساب و مصئونیت.", body: "اعلان تا چه زمانی فعال می‌ماند؟\nهر اعلان ۳۰ روز فعال است و پس از انقضا فقط صاحب آن می‌تواند دوباره نشرش کند.\n\nچگونه با فروشنده تماس بگیرم؟\nاگر فروشنده اجازه داده باشد، از دکمه تماس یا واتساپ استفاده کنید. کود تأیید خود را هرگز نفرستید.\n\nچرا اعلان من زیر بررسی است؟\nصاحبش دسته‌بندی، محتوای مصئون، عکس‌های واقعی و قیمت معتبر اعلان تازه را بررسی می‌کند.\n\nچگونه مشکل را گزارش کنم؟\nاز فورم تماس با صاحبش در پایین استفاده کنید و در صورت نیاز شناسه اعلان را بنویسید." },
      contact: { title: "تماس با صاحبش", intro: "درخواست پشتیبانی خود را از همین صفحه ارسال کنید.", body: "مشکل را روشن بنویسید و در صورت ارتباط، شناسه اعلان را اضافه کنید. رمز، کود تأیید، رمز بانکی یا سند هویتی خود را نفرستید." },
    },
  },
  ps: {
    ...
    info: {
      privacy: { title: "محرمیت", intro: "ستاسو محرمیت صاحبش ته مهم دی.", body: "د حساب، اعلان، ځای او اړیکو معلومات یوازې د بازار د چلولو او ساتنې لپاره کارول کېږي. کره ځای یوازې هغه وخت ښودل کېږي چې تاسو یې شریکول وغواړئ. پټنوم، تایید کوډ یا حساس پېژندپاڼې په اعلان یا پیغام کې مه خپروئ." },
      terms: { title: "د کارولو شرطونه", intro: "صاحبش په رښتینولۍ، خوندي او قانوني ډول وکاروئ.", body: "یوازې هغه رښتیني اعلانونه خپاره کړئ چې د وړاندې کولو اجازه یې لرئ. توکي سم تشریح کړئ، نورو کاروونکو ته درناوی وکړئ او منع، درغلیز، تبعیضي یا خطرناک منځپانګه مه خپروئ. صاحبش کولای شي د بازار له اصولو سرغړوونکې منځپانګه وڅېړي، محدوده یا ړنګه کړي." },
      ...
      faq: { title: "ډېرې پوښتل شوې پوښتنې", intro: "د پېر، پلور، حساب او خوندیتوب لنډ ځوابونه.", body: "اعلان تر کومه فعال وي؟\nهر اعلان ۳۰ ورځې فعال وي او له پای وروسته یې یوازې خاوند بیا خپرولای شي.\n\nله پلورونکي سره څنګه اړیکه ونیسم؟\nکه پلورونکي اجازه ورکړې وي، د زنګ یا واټس‌اپ تڼۍ وکاروئ. خپل تایید کوډ مه لېږئ.\n\nولې زما اعلان تر کتنې لاندې دی؟\nصاحبش د نوي اعلان سمه کټګوري، خوندي منځپانګه، رښتیني انځورونه او معتبره بیه ګوري.\n\nستونزه څنګه راپور کړم؟\nلاندې د صاحبش اړیکې فورمه وکاروئ او د اړتیا پر مهال د اعلان پېژند ولیکئ." },
      contact: { title: "له صاحبش سره اړیکه", intro: "د ملاتړ غوښتنه له همدې پاڼې ولېږئ.", body: "ستونزه روښانه ولیکئ او که اړینه وي د اعلان پېژند ورسره زیات کړئ. پټنوم، تایید کوډ، بانکي رمز یا د هویت اسناد مه لېږئ." },
    },
  },
