...
export const UI_TRANSLATIONS: Record<AppLocale, UiTranslations> = {
  en: {
    dashboard: {
      ...
      settingsLanguageDescription: "Choose English, Dari, or Pashto from the language menu. Your choice is saved.",
      settingsNotificationsTitle: "Notifications",
      settingsNotificationsDescription: "Choose which marketplace updates you want to receive.",
  ...
  fa: {
    dashboard: {
      ...
      settingsLanguageDescription: "از فهرست زبان، انگلیسی، دری یا پشتو را انتخاب کنید. انتخاب شما ذخیره می‌شود.",
      settingsNotificationsTitle: "اعلان‌ها",
      settingsNotificationsDescription: "مشخص کنید کدام خبرهای بازار را دریافت کنید.",
    ...
    location: {
      ...
      methodCurrentDescription: "اجازه دهید صاحبش موقعیت شما را خودکار تشخیص دهد (سریع‌تر)",
  ...
  ps: {
    dashboard: {
      ...
      settingsLanguageDescription: "له ژبې لست څخه انګلیسي، دري یا پښتو وټاکئ. ټاکنه مو ساتل کېږي.",
      settingsNotificationsTitle: "خبرتیاوې",
      settingsNotificationsDescription: "وټاکئ چې د بازار کوم خبرونه ترلاسه کول غواړئ.",
    ...
    location: {
      ...
      methodCurrentDescription: "پرېږدئ صاحبش ستاسو ځای په اوتومات ډول وپېژني (چټک)",
