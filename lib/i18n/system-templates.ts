...
const TEMPLATES: Record<AppLocale, Record<UserEvent, Template>> = {
  ...
  fa: {
    WELCOME: { subject: "به صاحبش خوش آمدید", body: "حساب صاحبش شما آماده است." },
    VERIFY_EMAIL: { subject: "ایمیل صاحبش خود را تأیید کنید", body: "برای تأیید ایمیل از لینک امن تأیید استفاده کنید." },
    PASSWORD_RESET: { subject: "بازنشانی رمز صاحبش", body: "از لینک امن بازنشانی رمز استفاده کنید. اگر این درخواست از شما نیست، پیام را نادیده بگیرید." },
    LISTING_SUBMITTED: { subject: "اعلان شما ثبت شد", body: "اعلان شما زیر بررسی است. هنگام تغییر وضعیت به شما خبر می‌دهیم." },
    LISTING_APPROVED: { subject: "اعلان شما فعال شد", body: "اعلان شما تأیید شد و اکنون در صاحبش نمایش داده می‌شود." },
    ...
    LISTING_REJECTED: { subject: "اعلان شما تأیید نشد", body: "برای دیدن تصمیم و گام بعدی، حساب صاحبش خود را باز کنید." },
    SECURITY_ALERT: { subject: "هشدار امنیتی صاحبش", body: "یک رویداد امنیتی در حساب شناسایی شد. اگر آن را نمی‌شناسید، حساب را بررسی و رمز را تغییر دهید." },
  },
  ps: {
    WELCOME: { subject: "صاحبش ته ښه راغلاست", body: "ستاسو د صاحبش حساب چمتو دی." },
    VERIFY_EMAIL: { subject: "خپل صاحبش برېښنالیک تایید کړئ", body: "د برېښنالیک د تایید لپاره خوندي تاییدي لینک وکاروئ." },
    PASSWORD_RESET: { subject: "د صاحبش پټنوم بیا وټاکئ", body: "خوندي د پټنوم بیاټاکلو لینک وکاروئ. که غوښتنه مو نه وي کړې، دا پیغام له پامه وغورځوئ." },
    LISTING_SUBMITTED: { subject: "ستاسو اعلان ثبت شو", body: "اعلان مو تر کتنې لاندې دی. د حالت په بدلېدو به خبر درکړو." },
    LISTING_APPROVED: { subject: "ستاسو اعلان فعال شو", body: "اعلان مو تایید شو او اوس په صاحبش کې ښکاري." },
    CHANGES_REQUESTED: { subject: "ستاسو اعلان بدلون ته اړتیا لري", body: "د کتونکي یادښت وګورئ، اعلان سم او بیا یې ثبت کړئ." },
    LISTING_REJECTED: { subject: "ستاسو اعلان تایید نه شو", body: "د پرېکړې او راتلونکو ګامونو لپاره خپل صاحبش حساب پرانیزئ." },
    SECURITY_ALERT: { subject: "د صاحبش امنیتي خبرتیا", body: "په حساب کې امنیتي پېښه وموندل شوه. که یې نه پېژنئ، حساب وګورئ او پټنوم بدل کړئ." },
  },
};
