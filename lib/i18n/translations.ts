...
export const TRANSLATIONS: Record<AppLocale, TranslationTree> = {
  en: {
    ...
    listing: {
      ...
      vehicleWheelDrive: "Drive System",
      vehicleColor: "Color",
...
// Afghanistan Dari coverage for the marketplace flows.  Keep this separate
// from the legacy seed strings above so we never silently fall back to English
// when a visitor selects Dari.
const DARI_COVERAGE_OVERRIDES: Record<string, unknown> = {
  auth: {
    supabaseMissing: "تنظیمات Supabase هنوز تکمیل نشده است.",
  },
  search: {
    intentDetected: "منظور تشخیص داده شد", brand: "برند", model: "مدل", related: "مرتبط", subcategory: "دسته فرعی", any: "همه", yes: "بلی", no: "نخیر", showing: "نمایش",
    noResults: "هیچ اعلانی با این فیلترها پیدا نشد. یک یا چند فیلتر را بردارید.",
  },
  listing: {
    backToListings: "بازگشت به اعلان‌ها", category: "دسته‌بندی", wantedAd: "اعلان نیازمندی", suitableForStudents: "این محل برای محصلان مناسب است.", posted: "نشر شده", vehicleSummary: "خلاصه وسیله نقلیه", sellerInformation: "معلومات فروشنده", name: "نام", phone: "شماره تماس", joined: "عضویت", minimumOffer: "کمترین پیشنهاد", callSeller: "تماس با فروشنده", message: "پیام", offer: "پیشنهاد", description: "توضیحات", video: "ویدیو", openVehicleVideo: "باز کردن ویدیوی وسیله", featureChecklist: "فهرست ویژگی‌ها", additionalDetails: "جزئیات بیشتر", specifications: "مشخصات", noAdditionalDetails: "جزئیات بیشتری ارائه نشده است.", autoFilledSpecifications: "مشخصات تکمیل‌شده خودکار", buyerSafetyWarning: "هشدار مصونیت خریدار", safety1: "پیش از دیدن وسیله، پول پیش پرداخت نکنید.", safety2: "اسناد وسیله را بررسی کنید.", safety3: "در صورت امکان در محل امن و عمومی ملاقات کنید.", safety4: "پیش از پرداخت، مالکیت را تأیید کنید.", addToFavorites: "افزودن به علاقه‌مندی‌ها", reportListing: "گزارش اعلان", reportTranslationIssue: "گزارش مشکل ترجمه", selectReportReason: "دلیل گزارش را انتخاب کنید", fraudOrScam: "فریب یا کلاهبرداری", wrongCategory: "دسته‌بندی نادرست", duplicateListing: "اعلان تکراری", prohibitedOrUnsafeItem: "کالای ممنوع یا ناامن", spamOrMisleading: "هرزنامه یا گمراه‌کننده", other: "سایر", optionalDetails: "جزئیات اختیاری", sendMessage: "ارسال پیام", hiAvailability: "سلام، آیا این مورد هنوز موجود است؟", sendYourOffer: "پیشنهاد خود را بفرستید", enterOfferedPrice: "قیمت پیشنهادی خود را وارد کنید", optionalNoteToSeller: "یادداشت اختیاری برای فروشنده", sendOffer: "ارسال پیشنهاد", call: "تماس", close: "بستن", viewOriginal: "دیدن متن اصلی", showTranslated: "نمایش ترجمه", translationUnavailable: "ترجمه هنوز در دسترس نیست.", listingNo: "شماره اعلان", listingDate: "تاریخ اعلان", sellerFallback: "فروشنده", notProvided: "ارائه نشده", originalLanguage: "زبان اصلی", messageInvalid: "پیش از ارسال، پیام بنویسید.", messageError: "فعلاً پیام فرستاده نشد. لطفاً دوباره کوشش کنید.", offerSent: "پیشنهاد شما فرستاده شد. منتظر تأیید فروشنده بمانید.", offerTooLow: "پیشنهاد شما از کمترین پیشنهاد این اعلان پایین‌تر است.", overview: "نمای کلی", condition: "وضعیت", location: "موقعیت", vehicleMake: "برند", vehicleSeries: "سری", vehicleModel: "مدل", vehicleType: "نوع وسیله", vehicleSubtype: "زیرنوع وسیله", vehicleManualBrand: "برند دستی", vehicleManualModel: "مدل دستی", vehicleYear: "سال", vehicleFuelType: "نوع سوخت", vehicleGear: "گیربکس", vehicleStatus: "وضعیت وسیله", vehicleBodyType: "نوع بدنه", vehicleKm: "کارکرد (کیلومتر)", vehicleEnginePower: "قدرت انجین", vehicleEngineCapacity: "حجم انجین", vehicleWheelDrive: "سیستم محرک", vehicleColor: "رنگ", vehicleFirstRegistration: "نخستین ثبت", vehiclePlateNumber: "شماره پلیت", vehiclePlateType: "نوع پلیت", vehicleEngineSize: "اندازه انجین (سلندر)", vehicleWarranty: "تضمین", vehicleSalvageRecord: "سابقه خسارت", vehiclePlateStatus: "وضعیت پلیت", vehicleSellerType: "نوع فروشنده", vehicleExchange: "معاوضه", vehicleManualEntry: "ورود دستی", vehicleClassic: "وسیله کلاسیک", vehicleCustom: "وسیله سفارشی",
  },
  postAd: {
    detailsStepTitle: "۲. جزئیات", detailsStepSubtitle: "فورم براساس دسته‌بندی انتخاب‌شده شما تنظیم می‌شود.", categoryNotSelected: "دسته‌بندی انتخاب نشده است", title: "عنوان", description: "توضیحات", price: "قیمت", currency: "اسعار", contactPhone: "شماره تماس", contactName: "نام تماس", contactPreferences: "روش تماس", contactPreferencesPlaceholder: "تماس، واتساپ، پیام و غیره", locationMovedNote: "موقعیت در مرحله جداگانه نزدیک پایان فورم قرار دارد.", realEstateDetails: "جزئیات املاک", listingPurpose: "هدف اعلان", select: "انتخاب کنید", forSale: "برای فروش", forRent: "برای کرایه", gerawyRahn: "گروی / رهن", exchange: "معاوضه", wanted: "نیازمندی", rooms: "اتاق‌ها", bathrooms: "تشناب‌ها", propertySize: "مساحت ملک", landSizeOptional: "مساحت زمین (اختیاری)", documentType: "نوع سند", ownerAgent: "مالک / دلال", owner: "مالک", agent: "دلال", studentHousing: "اقامت محصلان", suitableForStudentsQuestion: "آیا برای محصلان مناسب است؟", yes: "بلی", no: "نخیر", genderSuitable: "مناسب برای", distanceToUniversity: "فاصله تا پوهنتون (کیلومتر)", furnished: "مبله", sharedAllowed: "اشتراک مجاز", numberOfStudentsAllowed: "تعداد محصلان مجاز", dormitoryDetails: "جزئیات لیلیه", paymentPeriod: "دوره پرداخت", genderAllowed: "جنسیت مجاز", roomType: "نوع اتاق", numberOfBeds: "تعداد تخت", mealsIncluded: "غذا شامل است", water: "آب", electricity: "برق", internet: "انترنت", heating: "گرمایش", airConditioning: "کولر", security: "امنیت", rulesOptional: "قوانین (اختیاری)", studentHousingCollectionDetails: "جزئیات اقامت محصلان", propertyType: "نوع ملک", house: "خانه", apartment: "آپارتمان", room: "اتاق", dormitory: "لیلیه", vehicleDetails: "جزئیات وسیله", brand: "برند", model: "مدل", year: "سال", km: "کیلومتر", fuelType: "نوع سوخت", transmission: "گیربکس", condition: "وضعیت", plateStatus: "وضعیت پلیت", damagePaintReport: "گزارش آسیب / رنگ", phonesElectronicsDetails: "جزئیات موبایل و الکترونیک", storage: "حافظه", ramOptional: "رام (اختیاری)", warranty: "تضمین", secondHandDetails: "جزئیات اجناس دست‌دوم", itemType: "نوع جنس", brandOptional: "برند (اختیاری)", additionalCategoryFields: "فیلدهای بیشتر دسته‌بندی", confirmRules: "تأیید می‌کنم که این اعلان مطابق قوانین افغانستان است.", photosStepTitle: "۳. عکس‌ها", photosRequired: "برای این دسته‌بندی عکس لازم است.", photosOptional: "عکس برای این دسته‌بندی اختیاری است.", recommended: "پیشنهادشده", addPhotos: "افزودن عکس", primary: "اصلی", remove: "برداشتن", addMore: "افزودن بیشتر", whereLocated: "این جنس در کجا قرار دارد؟", chooseLocationMethod: "روش افزودن موقعیت را انتخاب کنید.", useMyLocation: "استفاده از موقعیت من", detectAutomatically: "موقعیت دستگاه شما خودکار تشخیص می‌شود.", manualLocation: "موقعیت دستی", chooseProvinceDistrict: "ولایت و ولسوالی را خودتان انتخاب کنید.", detectingLocation: "در حال تشخیص موقعیت دستگاه...", province: "ولایت", district: "ولسوالی", areaNeighborhoodOptional: "ناحیه / محله (اختیاری)", locationVisibility: "نمایش موقعیت", hideExactShowProvinceDistrict: "موقعیت دقیق پنهان باشد؛ فقط ولایت و ولسوالی نشان داده شود", showApproximateLocation: "نمایش موقعیت تقریبی", showExactLocation: "نمایش موقعیت دقیق", detectedLocation: "موقعیت تشخیص‌شده", latitude: "عرض‌البلد", longitude: "طول‌البلد", accuracy: "دقت", unknown: "نامشخص", confirmLocation: "تأیید موقعیت", previewStepTitle: "پیش‌نمایش", publishStepTitle: "نشر", publishReady: "اعلان شما آماده است. برای فرستادن به بررسی، نشر را بزنید.", categoryLabel: "دسته‌بندی", provinceDistrict: "ولایت / ولسوالی", photosLabel: "عکس‌ها", back: "برگشت", publishing: "در حال نشر...",
  },
  postAdElectronics: {
    phonesElectronics: "موبایل و الکترونیک", category: "دسته‌بندی", brandModel: "برند و مدل", details: "جزئیات", photos: "عکس‌ها", location: "موقعیت", preview: "پیش‌نمایش", chooseSubcategory: "یک دسته فرعی موبایل و الکترونیک انتخاب کنید.", popularBrandsHint: "برندهای محبوب برای ثبت سریع‌تر در اول نشان داده می‌شوند.", selectBrand: "برند را انتخاب کنید", selectModel: "مدل را انتخاب کنید", cantFindModel: "مدل خود را پیدا نکردید؟ دستی وارد کنید.", manualBrand: "برند دستی", manualModel: "مدل دستی", knownSpecs: "مشخصات شناخته‌شده", storage: "حافظه", color: "رنگ", batteryHealthOptional: "صحت باتری (اختیاری)", warranty: "تضمین", repairHistory: "سابقه ترمیم", networkRegistered: "ثبت شبکه", boxIncluded: "جعبه موجود است", chargerIncluded: "شارژر موجود است", photosRequiredMin: "عکس لازم است. حداقل", photosOptional: "عکس اختیاری است.", areaOptional: "ناحیه (اختیاری)", path: "مسیر", locationLabel: "موقعیت",
  },
};
...
export function getSafeTranslations(locale: AppLocale): TranslationTree {
  ...
  const localized = locale === "fa"
    ? (mergeOverrides(merged as unknown as Record<string, unknown>, DARI_COVERAGE_OVERRIDES) as TranslationTree)
    : merged;
