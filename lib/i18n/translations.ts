...
export const TRANSLATIONS: Record<AppLocale, TranslationTree> = {
  ...
  fa: {
    ...
    listing: {
      ...
      vehiclePlateNumber: "نمبر پلیت",
      vehiclePlateType: "نوع پلیت نمبر",
      vehicleEngineSize: "اندازه ماشین (سیلندر)",
      vehicleWarranty: "تضمین",
      vehicleSalvageRecord: "سابقه خسارت",
      vehiclePlateStatus: "وضعیت پلیت",
      vehicleSellerType: "نوع فروشنده",
  ...
  ps: {
    ...
    listing: {
      ...
      vehicleColor: "رنګ",
      vehicleFirstRegistration: "لومړی ثبت",
      vehiclePlateNumber: "د پلیت نمبر",
      vehiclePlateType: "د نمبر پلیت ډول",
