...
const CRITICAL_TRANSLATION_OVERRIDES: Partial<Record<AppLocale, Record<string, unknown>>> = {
  fa: {
    ...
    listing: {
      ...
      suitableForStudents: "این مکان برای دانشجویان مناسب است.",
      posted: "تاریخ انتشار",
      sellerInformation: "اطلاعات فروشنده",
      name: "نام",
      phone: "تلفن",
      joined: "عضو شده در",
      ...
      description: "توضیحات",
      video: "ویدیو",
      openVehicleVideo: "باز کردن ویدیوی اعلان",
      autoFilledSpecifications: "مشخصات تکمیل شده خودکار",
      buyerSafetyWarning: "هشدار ایمنی خریدار",
      ...
      messageInvalid: "لطفا قبل از ارسال، پیام خود را بنویسید.",
      ...
      offerTooLow: "پیشنهاد شما کمتر از حداقل پیشنهاد این اعلان است.",
    },
    postAd: {
      postAd: "ثبت اعلان",
      step: "مرحله",
  ...
  ps: {
    ...
    listing: {
      ...
      phone: "تلیفون",
      joined: "غړیتوب نېټه",
      minimumOffer: "لږ تر لږه وړاندیز",
      callSeller: "پلورونکي ته زنګ",
      message: "پیغام",
      offer: "وړاندیز",
      description: "تشریح",
      video: "ویډیو",
      openVehicleVideo: "د اعلان ویډیو پرانیزئ",
      autoFilledSpecifications: "په اوتومات ډول ډک شوي مشخصات",
      buyerSafetyWarning: "د پېرودونکي خوندیتوب خبرداری",
      addToFavorites: "خوښې کې اضافه کړئ",
      ...
      call: "زنګ",
      close: "بندول",
      viewOriginal: "اصلي نسخه وګورئ",
      showTranslated: "ژباړه وښایئ",
      translationUnavailable: "ژباړه لا تر اوسه شتون نه لري.",
      sellerFallback: "پلورونکی",
      notProvided: "نه دی ورکړل شوی",
      originalLanguage: "اصلي ژبه",
      messageInvalid: "مهرباني وکړئ د لېږلو مخکې پیغام ولیکئ.",
      messageError: "اوس مهال پیغام نه لېږل کېږي. مهرباني وکړئ بیا هڅه وکړئ.",
      offerSent: "ستاسو وړاندیز ولېږل شو. مهرباني وکړئ د پلورونکي تایید ته انتظار وباسئ.",
      offerTooLow: "ستاسو وړاندیز د دې اعلان له لږ تر لږه وړاندیز څخه کم دی.",
    },
    postAd: {
      postAd: "اعلان ثبت کړئ",
      step: "پړاو",
